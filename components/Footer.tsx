    ...
    >
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Facebook Page Embed - Full Width Section */}
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="text-center mb-6">
              <h4 className="text-lg font-semibold text-gray-100 mb-2">Follow Us on Facebook</h4>
              <p className="text-gray-400 text-sm">Stay connected with our latest adventures and updates</p>
            </div>
