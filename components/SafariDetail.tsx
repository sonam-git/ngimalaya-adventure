      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative h-96 rounded-2xl overflow-hidden mb-8">
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="p-8">
              <h1 className="text-4xl md:text-6xl jaini-purva-regular font-bold text-white mb-4">{safari.name}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-6 shadow-lg`}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  ...
                  <p className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{safari.duration}</p>
                </div>
                <div className="text-center">
                  ...
                  <p className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{safari.location}</p>
                </div>
                <div className="text-center">
                  <Binoculars className={`mx-auto mb-2 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`} size={24} />
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Park Type</p>
                  <p className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{safari.type}</p>
                </div>
                <div className="text-center">
                  <Thermometer className={`mx-auto mb-2 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`} size={24} />
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Best Time</p>
                  <p className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{safari.bestTime.split('.')[0]}</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-6 shadow-lg`}>
                <h3 className={`text-xl jaini-purva-regular font-semibold mb-4 flex items-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                  <Trees className="mr-2 text-green-500" size={24} />
                  Wildlife to Spot
                </h3>
                <ul className="space-y-2">
                  {safari.wildlife.map((animal, index) => (
                    <li key={index} className="flex items-start space-x-2">
                      ...
                      <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>{animal}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-6 shadow-lg`}>
                ...
                <ul className="space-y-2">
                  {safari.activities.map((activity, index) => (
                    <li key={index} className="flex items-start space-x-2">
                      <CheckCircle className={`mt-1 flex-shrink-0 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`} size={16} />
            ...
            {/* Best Time to Visit */}
            <div className={`${isDarkMode ? 'bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-800' : 'bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200'} rounded-2xl p-6 shadow-lg`}>
          ...
          <div className="space-y-6">
            ...
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-6 shadow-lg`}>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  <Binoculars className="text-green-500" size={20} />
                  <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
