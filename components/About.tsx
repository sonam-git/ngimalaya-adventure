...
const About: React.FC<{ showFull?: boolean }> = ({ showFull = true }) => {
  ...
  return (
    <section id="about" className="scroll-offset-mobile relative transition-colors duration-300 overflow-hidden w-full rounded-2xl sm:rounded-3xl shadow-2xl py-12 xl:py-16">
        ...
        <div className={`grid xl:grid-cols-2 gap-12 items-center max-w-6xl mx-auto ${showFull ? 'mb-16' : 'mb-0'}`}>
          ...
          <div>
            <h3 className={`text-2xl xl:text-3xl 2xl:text-4xl jaini-purva-regular mb-6 ${
             ...
             <h4 className={`text-xl times-new-roman font-semibold mb-3 text-primary-700 dark:text-blue-200`} style={{ fontFamily: "'Times New Roman', Times, serif" }}>
