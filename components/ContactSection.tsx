...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="scroll-offset-mobile relative transition-colors duration-300 overflow-hidden w-full rounded-2xl sm:rounded-3xl shadow-2xl py-12 xl:py-16 ">
