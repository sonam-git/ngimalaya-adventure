              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="order-2 xl:order-3 xl:col-span-3">
                  <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-6 shadow-lg`}>
                    ...
                    {/* Peak Stats - Always visible */}
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                      ...
                      <div className="text-center">
                        ...
                        <p className={`text-xs ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Peak Height</p>
                      ...
                      <div className="text-center">
                        ...
                        <p className={`text-xs ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Difficulty</p>
                      ...
                      <div className="text-center">
                        ...
                        <p className={`text-xs ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Best Season</p>
                  ...
                  {!peak.itinerary || peak.itinerary.length === 0 ? (
                    ...
                    >
                      {peak.itinerary.map((day, index) => (
                        <div key={index} className={`border-l-4 border-blue-500 pl-6 pb-4 ${index !== peak.itinerary!.length - 1 ? 'border-b border-gray-200 dark:border-gray-700' : ''}`}> 
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mt-4">
                            {day.altitude && (
                              <div className={`${isDarkMode ? 'bg-gray-700' : 'bg-blue-50'} rounded-lg p-3 flex items-center space-x-2`}>
                                <Mountain className={`${isDarkMode ? 'text-blue-400' : 'text-blue-600'} flex-shrink-0`} size={18} />
                                <div>
                                  <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Altitude</p>
                                  <p className={`text-sm font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{day.altitude}</p>
                                </div>
                              </div>
                            )}
                            ...
                            {day.duration && (
                              <div className={`${isDarkMode ? 'bg-gray-700' : 'bg-green-50'} rounded-lg p-3 flex items-center space-x-2`}>
                                <Clock className={`${isDarkMode ? 'text-green-400' : 'text-green-600'} flex-shrink-0`} size={18} />
                                <div>
                                  <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Duration</p>
                                  <p className={`text-sm font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{day.duration}</p>
                                </div>
                              </div>
                            )}
                            ...
                            {day.accommodation && (
                              <div className={`${isDarkMode ? 'bg-gray-700' : 'bg-orange-50'} rounded-lg p-3 flex items-center space-x-2`}>
                                <Home className={`${isDarkMode ? 'text-orange-400' : 'text-orange-600'} flex-shrink-0`} size={18} />
                                <div>
                            ...
                            {day.meals && (
                              <div className={`${isDarkMode ? 'bg-gray-700' : 'bg-red-50'} rounded-lg p-3 flex items-center space-x-2`}>
                                <Utensils className={`${isDarkMode ? 'text-red-400' : 'text-red-600'} flex-shrink-0`} size={18} />
                                <div>
                  ...
                  {peak.itinerary && peak.itinerary.length > 0 ? (
                    <>
                      <p className="mb-2 font-normal" style={{ fontFamily: 'Lato, "Open Sans", Roboto, sans-serif', fontWeight: 400 }}>
                        This {peak.duration.toLowerCase()} expedition includes {peak.itinerary.length} days of detailed activities from arrival to departure.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        <span className="bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-400 px-2 py-1 rounded text-xs font-normal flex items-center gap-1.5" style={{ fontFamily: 'Lato, "Open Sans", Roboto, sans-serif', fontWeight: 400 }}>
                          <Calendar size={14} />
                          {peak.itinerary.length} Days Total
                        </span>
                        ...
                        <span className="bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-400 px-2 py-1 rounded text-xs font-normal flex items-center gap-1.5" style={{ fontFamily: 'Lato, "Open Sans", Roboto, sans-serif', fontWeight: 400 }}>
                          <Flag size={14} />
                          {peak.difficulty} Level
                        </span>
                        <button
                          onClick={() => setIsCustomTrekModalOpen(true)}
                          className={`px-3 py-1 rounded text-xs font-semibold flex items-center gap-1.5 transition-all duration-300 ${
                            isDarkMode 
                              ? 'bg-gray-700 hover:bg-gray-600 text-white' 
                              : 'bg-gray-200 hover:bg-gray-300 text-gray-900'
                          }`}
                    ...
                    <p className="mb-2 font-normal" style={{ fontFamily: 'Lato, "Open Sans", Roboto, sans-serif', fontWeight: 400 }}>
                      Itinerary information is not yet available. Please contact us for details or request a custom itinerary.
                    </p>
                  )}
                </div>
              )}
